          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.role} onValueChange={(value) => setFormData({ ...formData, role: value })}>
                  ...
                  <SelectContent className="bg-white border border-gray-200 shadow-lg">
                    <SelectItem value="ceo" className="hover:bg-gray-50">CEO/Founder</SelectItem>
                    <SelectItem value="cto" className="hover:bg-gray-50">CTO</SelectItem>
                    <SelectItem value="developer" className="hover:bg-gray-50">Developer</SelectItem>
                    <SelectItem value="finance" className="hover:bg-gray-50">Finance</SelectItem>
                    <SelectItem value="operations" className="hover:bg-gray-50">Operations</SelectItem>
              ...
              <div className="flex items-start">
                <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500 mt-1" required />
